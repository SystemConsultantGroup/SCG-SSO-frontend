...
const messages: Record<MessageKey_defaultSet, string> = {
  ...
  deletingAccountForbidden:
    "자신의 계정을 삭제할 권한이 없습니다. 관리자에게 문의하세요.",
  kerberosNotConfigured: "Kerberos가 구성되지 않았습니다",
  kerberosNotConfiguredTitle: "Kerberos가 구성되지 않았습니다",
  bypassKerberosDetail:
    "Kerberos로 로그인하지 않았거나 브라우저가 Kerberos 로그인을 위해 설정되지 않았습니다. 다른 방법으로 로그인하려면 계속을 클릭하세요.",
  ...
  displayUnsupported: "요청된 표시 유형이 지원되지 않습니다",
  ...
  loginTotpStep1: "모바일에 다음 애플리케이션 중 하나를 설치합니다.",
  loginTotpStep2: "애플리케이션을 열고 바코드를 스캔합니다.",
  loginTotpStep3:
    "애플리케이션에서 제공하는 일회용 코드를 입력하고 제출을 클릭하여 설정을 완료합니다.",
  loginTotpStep3DeviceName:
    "OTP 장치를 관리하는 데 도움이 되도록 장치 이름을 제공합니다.",
  loginTotpManualStep2: "애플리케이션을 열고 키를 입력합니다.",
  loginTotpManualStep3:
    "애플리케이션에서 설정을 허용하는 경우 다음 구성 값을 사용합니다.",
  ...
  missingTotpMessage: "인증기 코드를 입력하세요.",
  missingTotpDeviceNameMessage: "장치 이름을 입력하세요.",
  ...
  "error-number-out-of-range-too-small": "숫자는 최소 {1} 값이어야 합니다.",
  "error-number-out-of-range-too-big": "숫자는 최대 {2} 값이어야 합니다.",
  "error-pattern-no-match": "잘못된 값입니다.",
  "error-invalid-uri": "잘못된 URL입니다.",
  "error-invalid-uri-scheme": "잘못된 URL 체계입니다.",
  "error-invalid-uri-fragment": "잘못된 URL 조각입니다.",
  "error-user-attribute-required": "이 필드를 입력하세요.",
  ...
  invalidPasswordExistingMessage: "잘못된 기존 비밀번호입니다.",
  invalidPasswordBlacklistedMessage: "잘못된 비밀번호: 비밀번호가 블랙리스트에 있습니다.",
  invalidPasswordConfirmMessage: "비밀번호 확인이 일치하지 않습니다.",
  invalidTotpMessage: "잘못된 인증기 코드입니다.",
  usernameExistsMessage: "사용자 이름이 이미 있습니다.",
  emailExistsMessage: "이메일이 이미 있습니다.",
  federatedIdentityExistsMessage:
    "{0} {1} 사용자가 이미 있습니다. 계정 관리에 로그인하여 계정을 연결하세요.",
  federatedIdentityUnavailableMessage:
    "ID 공급자 {1}로 인증된 사용자 {0}이(가) 없습니다. 관리자에게 문의하세요.",
  federatedIdentityUnmatchedEssentialClaimMessage:
    "ID 공급자가 발행한 ID 토큰이 구성된 필수 클레임과 일치하지 않습니다. 관리자에게 문의하세요.",
  confirmLinkIdpTitle: "계정이 이미 있습니다.",
  confirmOverrideIdpTitle: "브로커 연결이 이미 있습니다.",
  federatedIdentityConfirmLinkMessage:
    "{0} {1} 사용자가 이미 있습니다. 어떻게 계속하시겠습니까?",
  federatedIdentityConfirmOverrideMessage:
    "{0} 계정을 {1} 계정 {2}와 연결하려고 합니다. 하지만 계정은 이미 다른 {3} 계정 {4}와 연결되어 있습니다. 기존 연결을 새 계정으로 바꾸시겠습니까?",
  ...
  confirmOverrideIdpContinue: "예, 현재 계정으로 연결을 덮어씁니다.",
  ...
  emailSentMessage: "추가 지침이 포함된 이메일을 곧 받게 됩니다.",
  ...
  delegationFailedMessage:
    "이 브라우저 창을 닫고 콘솔 애플리케이션으로 돌아가서 다시 로그인을 시도해주세요.",
  ...
  invalidPasswordMinDigitsMessage:
    "잘못된 비밀번호: 최소 {0}개의 숫자 자리를 포함해야 합니다.",
  ...
  bearerOnlyMessage: "베어러 전용 애플리케이션은 브라우저 로그인을 시작할 수 없습니다.",
  ...
  unexpectedErrorRetrievingTokenMessage:
    "ID 공급자로부터 토큰을 검색하는 동안 예기치 않은 오류가 발생했습니다.",
  unexpectedErrorHandlingResponseMessage:
    "ID 공급자의 응답을 처리하는 동안 예기치 않은 오류가 발생했습니다.",
  ...
  unexpectedErrorHandlingRequestMessage:
    "ID 공급자에 대한 인증 요청을 처리하는 동안 예기치 않은 오류가 발생했습니다.",
  ...
  identityProviderUnexpectedErrorMessage:
    "ID 공급자로 인증하는 동안 예기치 않은 오류가 발생했습니다.",
  identityProviderMissingStateMessage: "ID 공급자의 응답에 상태 매개변수가 없습니다.",
  identityProviderMissingCodeOrErrorMessage:
    "ID 공급자의 응답에 코드 또는 오류 매개변수가 없습니다.",
  identityProviderInvalidResponseMessage: "ID 공급자의 잘못된 응답입니다.",
  identityProviderInvalidSignatureMessage: "ID 공급자의 응답에 잘못된 서명입니다.",
  identityProviderNotFoundMessage: "식별자를 가진 ID 공급자를 찾을 수 없습니다.",
  identityProviderLinkSuccess:
    "이메일 인증에 성공했습니다. 원래 브라우저로 돌아가서 로그인을 계속하세요.",
  staleCodeMessage:
  ...
  staleEmailVerificationLink:
    "클릭한 링크는 오래된 링크이며 더 이상 유효하지 않습니다. 이미 이메일을 인증했을 수 있습니다.",
  identityProviderAlreadyLinkedMessage:
    "{0}이(가) 반환한 페더레이션 ID가 이미 다른 사용자와 연결되었습니다.",
  confirmAccountLinking: "{1} ID 공급자의 {0} 계정을 계정과 연결할지 확인합니다.",
  confirmEmailAddressVerification: "{0} 이메일 주소의 유효성을 확인합니다.",
  confirmExecutionOfActions: "다음 작업을 수행합니다.",
  backToApplication: "&laquo; 처음으로 돌아가기",
  ...
  alreadyLoggedIn: "이미 로그인했습니다.",
  differentUserAuthenticated:
    "이 세션에서 다른 사용자 '{0}'으로 이미 인증되었습니다. 먼저 로그아웃하세요.",
  ...
  "console-verify-email":
    "이메일 주소를 인증해야 합니다. 인증 코드가 포함된 이메일을 {0}으로 보냈습니다. 아래 입력란에 이 코드를 입력하세요.",
  ...
  "otp-help-text": "인증기 애플리케이션의 인증 코드를 입력하세요.",
  ...
  "recovery-code-config-warning-title":
    "이 페이지를 나가면 이 복구 코드가 다시 나타나지 않습니다.",
  "recovery-code-config-warning-message":
    "인쇄, 다운로드 또는 비밀번호 관리자에 복사하여 안전하게 보관하세요. 이 설정을 취소하면 계정에서 이 복구 코드가 제거됩니다.",
  ...
  "recovery-codes-download-file-description":
    "복구 코드는 인증기에 액세스할 수 없는 경우 계정에 로그인할 수 있는 일회용 암호입니다.",
  ...
  "webauthn-error-different-user":
    "처음 인증된 사용자가 패스키로 인증된 사용자가 아닙니다.",
  ...
  errasingData: "모든 데이터 지우기",
  loggingOutImmediately: "즉시 로그아웃",
  accountUnusable: "이 계정으로는 더 이상 애플리케이션을 사용할 수 없습니다.",
  userDeletedSuccessfully: "사용자가 성공적으로 삭제되었습니다.",
  "access-denied": "액세스 거부",
  "access-denied-when-idp-auth": "{0}으로 인증하는 동안 액세스 거부됨",
  "frontchannel-logout.title": "로그아웃",
  "frontchannel-logout.message": "다음 앱에서 로그아웃합니다.",
  ...
  "organization.confirm-membership": "아래 링크를 클릭하면 {0} 조직의 회원이 됩니다.",
  "organization.member.register.title": "${kc.org.name} 조직에 가입할 계정을 생성합니다.",
